...
while x >= 0       # Loop while x is greater than or equal to 0
  puts x             #   Print out the value of x
  x = x - 1          #   Subtract 1 from x
end                  # The loop ends here
...
until x > 10 		# Loop until x is greater than 10
  puts x
  x = x + 1
end                  # Loop ends here
---------------------------
...
Collection is any object that defines each method. It is like any other iterator 
(collect,reject etc) as it depends on each.

The loop variable or variables of a for loop are not local to the loop; they 
remain defined after the loop exits.

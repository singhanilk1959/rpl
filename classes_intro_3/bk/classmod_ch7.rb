...
# The new method of the class object craetes a new instance and automatically
...
# <==> operatorr and have mixed in Comparable
...
## In Ruby, Initalize is an ordinary method and is inherited like any other.
...
# Otherwise, extend the functionality by encapsulationg and delegating to oi.
...
************* Modules ******************
************* Module as namespace******************
# Module is a subclass of Class
# Modules are use as namespaces and mixins

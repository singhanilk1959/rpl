#!/usr/bin/env ruby
print %q-
The constant_missing method of Module performs a similar function as method_missing for the constants lookup algorithm 
and allows us to compute or lazily initialize constants on the fly.

This module defines a constant for every Unicode codepoint from U+0000 to U+10FFFF.
-
puts ; gets
print %q%

...
"Ruby is designed to make programmers happy"....Yukhiro Matsumoto...known as Matz...creator of Ruby"

Ruby draws inspiration from Lisp, Smalltalk, and Perl, but uses a grammar that is easy for C and Java programmers.
Ruby is a pure Object oriented language, but it is also suitable for procedural and functional programming styles.

Ruby includes powerful metaprogramming capabilities and can be used to create domain-specific languages or DSLs.
...
# paranthesis in method invocations are optional , especially in no arguments situation.
# Ruby is very strict about object encapsulation...access to internal state is through accessor methods
...
---------------------------
a = [3, 2, 1]     # This is an array literal. Array indexing starts at 0.
print a[0]        # 3

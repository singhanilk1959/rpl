...
' if you need to place an apostrophe, precede it with backslash'
' the blackslash also works to escape another blackslash'
...
'Two backslashes: \\\\'
---------------------------
' blackslash is a simple character if not followed by ' or \ '
'a\b' == 'a\\b'
---------------------------
